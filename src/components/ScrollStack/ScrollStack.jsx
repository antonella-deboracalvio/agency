  ...
  const updateCardTransforms = useCallback(() => {
    ...
    cardsRef.current.forEach((card, index) => {
      ...
      if (blurAmount) {
        ...
        for (let stackIndex = 0; stackIndex < cardsRef.current.length; stackIndex += 1) {
          const stackCardTop = getElementOffset(cardsRef.current[stackIndex]);
          const stackTriggerStart = stackCardTop - stackPositionPx - itemStackDistance * stackIndex;

          if (scrollTop >= stackTriggerStart) {
